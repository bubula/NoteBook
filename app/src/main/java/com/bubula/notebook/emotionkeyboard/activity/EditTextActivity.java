...
public class EditTextActivity extends AppCompatActivity {
    ...
    public void initEmotionMainFragment(){
        ...
        //绑定主内容编辑框
        bundle.putBoolean(FaceGroupFragment.BIND_TO_EDITTEXT,false);
        //隐藏控件
        bundle.putBoolean(FaceGroupFragment.HIDE_BAR_EDITTEXT_AND_BTN,true);
        //替换fragment
        //创建修改实例
        faceGroupFragment = FaceGroupFragment.newInstance(FaceGroupFragment.class,bundle);
        faceGroupFragment.bindToContentView(et_emotion);
