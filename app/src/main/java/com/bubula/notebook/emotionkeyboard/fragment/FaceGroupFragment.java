package com.bubula.notebook.emotionkeyboard.fragment;
...
import com.bubula.notebook.emotionkeyboard.adapter.HorizontalRecyclerviewAdapter;
import com.bubula.notebook.emotionkeyboard.adapter.NoHorizontalScrollerVPAdapter;
import com.bubula.notebook.emotionkeyboard.emotionkeyboardview.MultiTypeKeyboardManger;
import com.bubula.notebook.emotionkeyboard.emotionkeyboardview.NoHorizontalScrollerViewPager;
import com.bubula.notebook.emotionkeyboard.model.ImageModel;
import com.bubula.notebook.emotionkeyboard.utils.EmotionUtils;
import com.bubula.notebook.emotionkeyboard.utils.GlobalOnItemClickManagerUtils;
import com.bubula.notebook.emotionkeyboard.utils.SharedPreferencedUtils;
 ...
 * Description:表情主界面
 */
public class FaceGroupFragment extends BaseFragment {
    ...
    //表情面板
    private MultiTypeKeyboardManger mMultiTypeKeyboardManger;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        isHidenBarEditTextAndBtn= args.getBoolean(FaceGroupFragment.HIDE_BAR_EDITTEXT_AND_BTN);
        //获取判断绑定对象的参数
        isBindToBarEditText=args.getBoolean(FaceGroupFragment.BIND_TO_EDITTEXT);
        initView(rootView);
        mMultiTypeKeyboardManger = MultiTypeKeyboardManger.with(getActivity())
        ...
        if(isBindToBarEditText){
            ...
            mMultiTypeKeyboardManger.bindToEditText((EditText)contentView);
        }
        return rootView;
    }
    ...
    private void replaceFragment(){
        ...
        //创建修改实例
        EmojiFaceFragment f1= (EmojiFaceFragment) factory.getFragment(EmotionUtils.EMOTION_CLASSIC_TYPE);
        fragments.add(f1);
        Bundle b=null;
        for (int i=0;i<7;i++){
            b=new Bundle();
    ...
    public boolean isInterceptBackPress(){
        return mMultiTypeKeyboardManger.interceptBackPress();
    }
}
