...
package com.bubula.notebook.emotionkeyboard.utils;
...
public class EmotionUtils {
    ...
    static {
        ...
        EMOTION_CLASSIC_MAP.put("[U+1F602]", 0x1F602);
        EMOTION_CLASSIC_MAP.put("[U+1F603]", 0x1F603);
        EMOTION_CLASSIC_MAP.put("[U+1F604]", 0x1F604);
        EMOTION_CLASSIC_MAP.put("[U+1F605]", 0x1F605);
        EMOTION_CLASSIC_MAP.put("[U+1F602]", 0x1F602);
        EMOTION_CLASSIC_MAP.put("[U+1F603]", 0x1F603);
        EMOTION_CLASSIC_MAP.put("[U+1F604]", 0x1F604);
        EMOTION_CLASSIC_MAP.put("[U+1F605]", 0x1F605);
